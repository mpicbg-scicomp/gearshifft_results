...
#SBATCH --exclusive
#SBATCH --array 0-5
#SBATCH -o mkl2018u3-fftwwrappers-gnu/gearshifftcpu_array-%A_%a.out
#SBATCH -e mkl2018u3-fftwwrappers-gnu/gearshifftcpu_array-%A_%a.err

k=$SLURM_ARRAY_TASK_ID

CURDIR=${HOME}/development/gearshifft/
REL=$CURDIR/build-mkl
RESULTS=$CURDIR/results/broadwell/mkl2018u3-fftwwrappers-gnu
